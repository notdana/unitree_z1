...
print("position3")
arm.MoveJ([0.3,0.3,0.1,0.5,-0.2,0.5], gripper_pos, jnt_speed)
print("position4")
arm.MoveJ([0.2,0.4,0.1,0.5,-0.2,0.5], gripper_pos, jnt_speed)
print("position5")
arm.MoveJ([0.1,0.5,0.1,0.5,-0.2,0.5], gripper_pos, jnt_speed)
